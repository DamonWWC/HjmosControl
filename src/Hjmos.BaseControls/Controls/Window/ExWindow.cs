...
namespace Hjmos.BaseControls.Controls
{
    ...
    public class ExWindow : System.Windows.Window
    {
        ...
        static ExWindow()
        {
            StyleProperty.OverrideMetadata(typeof(ExWindow), new FrameworkPropertyMetadata(ResourceHelper.GetResource<Style>(ResourceToken.WindowWin10)));
        }
