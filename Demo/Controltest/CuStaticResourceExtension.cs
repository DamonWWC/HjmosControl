...
{
	[Localizability(LocalizationCategory.NeverLocalize), MarkupExtensionReturnType(typeof(object))]
	public class CuStaticResourceExtension : MarkupExtension
    {
		...
		//internal object ProvideValueInternal(IBamlReader bamlReader, object targetObject, object targetProperty, bool allowDeferredReference)
		//{
		//	if (this.ResourceKey == null)
		//	{
		//		throw new InvalidOperationException(SR.Get("MarkupExtensionResourceKey"));
		//	}
		//	bool flag = allowDeferredReference && (targetObject is FrameworkElementFactory || targetObject is Setter || targetObject is SharedDp);
		//	DeferredResourceReference prefetchedValue = this.PrefetchedValue;
		//	bool flag2 = prefetchedValue != null && !prefetchedValue.IsUnset;
		//	BamlRecordReader bamlReader2 = bamlReader.GetBamlReader();
		//	object obj;
		//	if (prefetchedValue != null)
		//	{
		//		obj = bamlReader2.FindResourceInParserStack(this.ResourceKey, flag, false);
		//	}
		//	else
		//	{
		//		obj = bamlReader2.FindResourceInParentChain(this.ResourceKey, flag, false);
		//	}
		//	if (obj == DependencyProperty.UnsetValue)
		//	{
		//		if (!flag2)
		//		{
		//			bamlReader2.ThrowException("ParserNoResource", "{" + this.ResourceKey.ToString() + "}");
		//		}
		//		else
		//		{
		...
		//			if (!flag)
		//			{
		//				obj = prefetchedValue.GetValue(BaseValueSourceInternal.Unknown);
		//			}
		//			else
		//			{
		//				obj = prefetchedValue;
