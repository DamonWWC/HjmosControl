...
namespace Hjmos.BaseControls.Controls
{
    ...
    public class ImageViewerPlus : Control
    {
        #region Constants
        ...
        public ImageViewerPlus(Uri uri) : this()
        {
            try
            {
        ...
        public ImageViewerPlus(string path) : this(new Uri(path))
        {
        }
        ...
        public static readonly DependencyProperty ShowImgMapProperty = DependencyProperty.Register(
            "ShowImgMap", typeof(bool), typeof(ImageViewerPlus), new PropertyMetadata(false));

        public static readonly DependencyProperty ImageSourceProperty = DependencyProperty.Register(
            "ImageSource", typeof(BitmapFrame), typeof(ImageViewerPlus), new PropertyMetadata(default(BitmapFrame), OnImageSourceChanged));

        private static void OnImageSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var ctl = (ImageViewerPlus)d;
            ctl.Init();
        }

        public static readonly DependencyProperty IsFullScreenProperty = DependencyProperty.Register(
            "IsFullScreen", typeof(bool), typeof(ImageViewerPlus), new PropertyMetadata(false));

        internal static readonly DependencyProperty ImgPathProperty = DependencyProperty.Register(
            "ImgPath", typeof(string), typeof(ImageViewerPlus), new PropertyMetadata(default(string)));

        internal static readonly DependencyProperty ImgSizeProperty = DependencyProperty.Register(
            "ImgSize", typeof(long), typeof(ImageViewerPlus), new PropertyMetadata(-1L));

        /// <summary>
        ///     是否显示全屏按钮
        /// </summary>
        internal static readonly DependencyProperty ShowFullScreenButtonProperty = DependencyProperty.Register(
            "ShowFullScreenButton", typeof(bool), typeof(ImageViewerPlus), new PropertyMetadata(false));

        /// <summary>
        ///     关闭按钮是否显示中
        /// </summary>
        internal static readonly DependencyProperty ShowCloseButtonProperty = DependencyProperty.Register(
            "ShowCloseButton", typeof(bool), typeof(ImageViewerPlus), new PropertyMetadata(false));

        internal static readonly DependencyProperty ImageContentProperty = DependencyProperty.Register(
            "ImageContent", typeof(object), typeof(ImageViewerPlus), new PropertyMetadata(default(object)));

        internal static readonly DependencyProperty ImageMarginProperty = DependencyProperty.Register(
            "ImageMargin", typeof(Thickness), typeof(ImageViewerPlus), new PropertyMetadata(default(Thickness)));

        internal static readonly DependencyProperty ImageWidthProperty = DependencyProperty.Register(
            "ImageWidth", typeof(double), typeof(ImageViewerPlus), new PropertyMetadata(0d));

        internal static readonly DependencyProperty ImageHeightProperty = DependencyProperty.Register(
            "ImageHeight", typeof(double), typeof(ImageViewerPlus), new PropertyMetadata(0d));

        internal static readonly DependencyProperty ImageScaleProperty = DependencyProperty.Register(
            "ImageScale", typeof(double), typeof(ImageViewerPlus), new PropertyMetadata(1d, OnImageScaleChanged));

        internal static readonly DependencyProperty ScaleStrProperty = DependencyProperty.Register(
            "ScaleStr", typeof(string), typeof(ImageViewerPlus), new PropertyMetadata("100%"));

        internal static readonly DependencyProperty ImageRotateProperty = DependencyProperty.Register(
            "ImageRotate", typeof(double), typeof(ImageViewerPlus), new PropertyMetadata(0d));

        internal static readonly DependencyProperty ShowSmallImgInternalProperty = DependencyProperty.Register(
            "ShowSmallImgInternal", typeof(bool), typeof(ImageViewerPlus), new PropertyMetadata(false));
        ...
        {
            if (d is ImageViewerPlus imageViewer && e.NewValue is double newValue)
            {
