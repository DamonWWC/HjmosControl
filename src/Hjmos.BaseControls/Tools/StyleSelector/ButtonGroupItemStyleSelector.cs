                    ...
                    case RadioButton _:
                        {
                            ...
                            return buttonGroup.Orientation == Orientation.Horizontal
                                ...
                                : ResourceHelper.GetResource<Style>(index == count - 1 ? ResourceToken.RadioGroupItemHorizontalLast : ResourceToken.RadioGroupItemDefault)
                                : index == 0
                                ? ResourceHelper.GetResource<Style>(ResourceToken.RadioGroupItemVerticalFirst) :
                                ResourceHelper.GetResource<Style>(index == count - 1 ? ResourceToken.RadioGroupItemVerticalLast : ResourceToken.RadioGroupItemDefault);
                        }
                    case Button _:
                        {
                            if(count==1)
                            ...
                            return buttonGroup.Orientation == Orientation.Horizontal
                                ...
                                ResourceHelper.GetResource<Style>(index == count - 1 ? ResourceToken.ButtonGroupItemVerticalLast : ResourceToken.ButtonGroupItemDefault);
                        }
                    case ToggleButton _:
                        {
                            if(count==1)
                            ...
                            return buttonGroup.Orientation == Orientation.Horizontal
                                ...
                                : ResourceHelper.GetResource<Style>(index == count - 1 ? ResourceToken.ToggleButtonGroupItemHorizontalLast : ResourceToken.ToggleButtonGroupItemDefault)
                                : index == 0
                                ? ResourceHelper.GetResource<Style>(ResourceToken.ToggleButtonGroupItemVerticalFirst)
                                : ResourceHelper.GetResource<Style>(index == count - 1 ? ResourceToken.ToggleButtonGroupItemVerticalLast : ResourceToken.ToggleButtonGroupItemDefault);
