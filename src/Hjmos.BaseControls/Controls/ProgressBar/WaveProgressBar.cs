...
namespace Hjmos.BaseControls.Controls
{
    ...
    public class WaveProgressBar : RangeBase
    {
        ...
        {
            FocusableProperty.OverrideMetadata(typeof(WaveProgressBar), new FrameworkPropertyMetadata(false));
            MaximumProperty.OverrideMetadata(typeof(WaveProgressBar), new FrameworkPropertyMetadata(100d));
        }
