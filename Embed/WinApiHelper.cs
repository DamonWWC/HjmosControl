...
namespace Embed
{
    public class WinApiHelper
    {
        ...
        public static extern uint SetWindowLong(IntPtr hwnd, WindowLong nIndex, uint newLong);
        ...
        public static extern bool ShowWindow([System.Runtime.InteropServices.InAttribute()] System.IntPtr hWnd, WindowShowStyle nCmdShow);
        ...
        /// <param name="dwFlags">LWA_ALPHA:0x00000002 使用 bAlpha 确定分层窗口的不透明度。LWA_COLORKEY:0x00000001 使用 crKey 作为透明度颜色。</param>
        /// <returns></returns>
        [DllImport("user32.dll")]
        ...
        public enum WindowExtendStyle : long
        {
