...
namespace Hjmos.BaseControls.Controls
{
    ...
    public class Pagination : Control
    {
        ...
        internal static readonly DependencyProperty MaxPageCountProperty =
            DependencyProperty.Register("MaxPageCount", typeof(int), typeof(Pagination), new PropertyMetadata(1, (o, args) =>
            {
        ...
        public static readonly DependencyProperty MaxNumProperty =
            DependencyProperty.Register("MaxNum", typeof(int), typeof(Pagination), new PropertyMetadata(default(int), (o, args) =>
            {
                if(o is Pagination pagination && args.NewValue is int value)
                {
        ...
        public static readonly DependencyProperty DataCountPerPageProperty =
            DependencyProperty.Register("DataCountPerPage", typeof(int), typeof(Pagination), new PropertyMetadata(10,(o,args)=>
            {
                if (o is Pagination pagination && args.NewValue is int value)
                {
                    pagination.UpdatePage();
        ...
        internal static readonly DependencyProperty MaxPageRangeProperty =
            DependencyProperty.Register("MaxPageRange", typeof(ObservableCollection<int>), typeof(Pagination), new PropertyMetadata(default(ObservableCollection<int>)));
        ...
        public static readonly DependencyProperty PageIndexProperty =
            DependencyProperty.Register("PageIndex", typeof(int), typeof(Pagination), new PropertyMetadata(1,(o,args)=> 
            {
                if(o is Pagination pagination && args.NewValue is int value)
                {
                    pagination.Update();
        ...
        public static readonly DependencyProperty MaxPageIntervalProperty =
            DependencyProperty.Register("MaxPageInterval", typeof(int), typeof(Pagination), new PropertyMetadata(2,(o,args)=>
            {
        ...
        public static readonly DependencyProperty JumpNumProperty =
            DependencyProperty.Register("JumpNum", typeof(int), typeof(Pagination), new PropertyMetadata(1,(o,args)=>
            {
                if(o is Pagination pagination && args.NewValue is int value)
                {
